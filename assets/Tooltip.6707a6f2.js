import{t as a,G as $,aC as g,n as b,aV as f,ah as l,x,z as m,r as v,D as O,B as u,aW as j,aX as T}from"./index.eb6c3f73.js";const{cubicBezierEaseInOut:s,cubicBezierEaseOut:C,cubicBezierEaseIn:E}=$;function S({overflow:n="hidden",duration:e=".3s",originalTransition:t="",leavingDelay:o="0s",foldPadding:i=!1,enterToProps:d=void 0,leaveToProps:h=void 0,reverse:c=!1}={}){const p=c?"leave":"enter",r=c?"enter":"leave";return[a(`&.fade-in-height-expand-transition-${r}-from,
