import{n as k,q as p,a1 as m,H as g,s as i,x as w,y as S,z as u,D as _,N as R,B as h,a8 as q,ah as c,t as r,ai as K,aj as A,a6 as G,M as $}from"./index.0a80cf5c.js";const J=e=>{const{textColor1:o,dividerColor:d,fontWeightStrong:l}=e;return{textColor:o,color:d,fontWeight:l}},Q={name:"Divider",common:k,self:J},U=Q,X=p("divider",`
 position: relative;
 display: flex;
 width: 100%;
...
`,[m("vertical",`
 ...
 `),r("td",`
 background-color: var(--n-td-color-popover);
 `)]))]),lo=Object.assign(Object.assign({},u.props),{bordered:{type:Boolean,default:!0},bottomBordered:{type:Boolean,default:!0},singleLine:{type:Boolean,default:!0},striped:Boolean,singleColumn:Boolean,size:{type:String,default:"medium"}}),ao=w({name:"Table",props:lo,setup(e){const{mergedClsPrefixRef:o,inlineThemeDisabled:d,mergedRtlRef:l}=S(e),a=u("Table","-table",to,eo,e,o),n=G("Table",l,o),t=_(()=>{const{size:b}=e,{self:{borderColor:v,tdColor:f,tdColorModal:x,tdColorPopover:C,thColor:z,thColorModal:P,thColorPopover:y,thTextColor:M,tdTextColor:B,borderRadius:T,thFontWeight:L,lineHeight:O,borderColorModal:j,borderColorPopover:V,tdColorStriped:D,tdColorStripedModal:E,tdColorStripedPopover:H,[$("fontSize",b)]:W,[$("tdPadding",b)]:F,[$("thPadding",b)]:I},common:{cubicBezierEaseInOut:N}}=a.value;return{"--n-bezier":N,"--n-td-color":f,"--n-td-color-modal":x,"--n-td-color-popover":C,"--n-td-text-color":B,"--n-border-color":v,"--n-border-color-modal":j,"--n-border-color-popover":V,"--n-border-radius":T,"--n-font-size":W,"--n-th-color":z,"--n-th-color-modal":P,"--n-th-color-popover":y,"--n-th-font-weight":L,"--n-th-text-color":M,"--n-line-height":O,"--n-td-padding":F,"--n-th-padding":I,"--n-td-color-striped":D,"--n-td-color-striped-modal":E,"--n-td-color-striped-popover":H}}),s=d?R("table",_(()=>e.size[0]),t,e):void 0;return{rtlEnabled:n,mergedClsPrefix:o,cssVars:d?void 0:t,themeClass:s==null?void 0:s.themeClass,onRender:s==null?void 0:s.onRender}},render(){var e;const{mergedClsPrefix:o}=this;return(e=this.onRender)===null||e===void 0||e.call(this),h("table",{class:[`${o}-table`,this.themeClass,{[`${o}-table--rtl`]:this.rtlEnabled,[`${o}-table--bottom-bordered`]:this.bottomBordered,[`${o}-table--bordered`]:this.bordered,[`${o}-table--single-line`]:this.singleLine,[`${o}-table--single-column`]:this.singleColumn,[`${o}-table--striped`]:this.striped}],style:this.cssVars},this.$slots)}});export{io as _,ao as a};
